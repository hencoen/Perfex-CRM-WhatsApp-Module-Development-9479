...
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a href="#whatsapp_conversation_form" data-toggle="collapse" aria-expanded="false" class="collapsed">
                        <i class="fa fa-plus"></i> <?php echo _l('add_new', _l('whatsapp_conversation')); ?>
                    </a>
                </h4>
            </div>
            <div id="whatsapp_conversation_form" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="summary" id="summary" placeholder="<?php echo _l('whatsapp_conversation_summary_placeholder'); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="conversation"><?php echo _l('whatsapp_conversation_content'); ?> <span class="text-danger">*</span></label>
                        <textarea name="conversation" id="conversation" rows="8" class="form-control" placeholder="<?php echo _l('whatsapp_conversation_content_placeholder'); ?>" required></textarea>
                    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <i class="fa fa-whatsapp"></i> <?php echo _l('whatsapp_conversations'); ?>
            ...
            <div class="panel-body">
                ...
                <div class="whatsapp-conversation-item" data-conversation-id="<?php echo $conversation->id; ?>">
                    <div class="conversation-header">
                        <div class="pull-left">
                            <strong><?php echo $conversation->staff_name; ?></strong>
                        ...
                        <div class="pull-right">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="<?php echo admin_url('whatsapp_conversations/delete/' . $conversation->id); ?>" 
                                   ...
                                   onclick="return confirm('<?php echo _l('confirm_delete'); ?>');">
                    ...
                    <div class="conversation-summary">
                        <strong><?php echo _l('summary'); ?>:</strong> <?php echo nl2br(htmlspecialchars($conversation->summary)); ?>
                    </div>
                    <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-conversation-form">
                    ...
                    <div class="form-group">
                        <label for="edit_conversation"><?php echo _l('whatsapp_conversation_content'); ?> <span class="text-danger">*</span></label>
